...
@Composable
fun PersonCreating(
    onPersonSave: (Fullname, Address?, EmailAddress?, Long?) -> Unit,
    backNavigation: () -> Unit = {},
        ...
        BasicLazyColumn {
            ...
            PrimaryButton(label = "Save") {
                if (firstnameValue.value.trim() != "" && lastnameValue.value.trim() != "") {
                    ...
                    val name = Fullname(firstnameValue.value, lastnameValue.value)
                    onPersonSave(name, address, email, phoneValue.value.toLongOrNull())
